...
window.SEED_DATA = {
  "_comment": "Fake but representative seed for the session-02 design-vision prototype. HTML-only, disposable (R5). Reproduces the session-02 mockups faithfully. NOTHING here is ratified — sensible prototype defaults for user testing only, subject to change. variance = extra − missing (negative = shortfall). Snapshot is intentionally NOT modelled as a screen: per human direction it runs in the background after settlement / on a configured interval — a later problem.",
  ...
  "users": [
    ...
    { "id": "U-APP2", "name": "Divya Menon", "role": "Approver" }
  ],
  ...
  "resolutionOptions": {
    "MISSING": [
      { "id": "action_item", "label": "Create action item" },
      { "id": "write_off", "label": "Write off as loss" },
      { "id": "recovery", "label": "Recover from responsible party", "ticket": true },
      { "id": "split", "label": "Split — recover + write off", "ticket": true, "split": true }
    ],
    "WASTE": [
      { "id": "action_item", "label": "Create action item" },
      { "id": "write_off", "label": "Write off as loss" },
    ...
    "EXPIRED": [
      { "id": "write_off", "label": "Write off as loss" },
      { "id": "recovery", "label": "Recover from seller", "ticket": true },
      { "id": "split", "label": "Split — recover + write off", "ticket": true, "split": true }
    ],
    "EXTRA": [
      { "id": "absorb", "label": "Absorb into stock" },
      { "id": "discard", "label": "Discard" },
      { "id": "return", "label": "Return to source", "ticket": true }
    ]
  },
  ...
  "audits": [
    ...
    {
      "id": "AUD-2405-010", "name": "Asset Verification - May", "warehouseId": "WH-03", "entity": "Asset",
      "auditorUserId": "U-3", "status": "submitted", "createdAt": "2024-05-29T09:00:00+05:30",
      "updatedAt": "2024-05-29T17:30:00+05:30", "submittedAt": "2024-05-29T17:30:00+05:30", "auditDate": "2024-05-29",
      "products": [
        { "productId": "A-01", "name": "Forklift FL-12", "sku": "AST-FL12", "batchNo": "—", "location": "BAY-03", "expected": 1, "actual": 0, "expired": 0, "waste": 0, "extra": 0, "classification": "MISSING", "reasonNarrative": "Not found at bay 3; last seen logged 3 weeks ago.", "evidence": { "photos": [{ "caption": "Empty bay 3" }], "documents": [] } },
        { "productId": "A-02", "name": "Pallet Jack PJ-3", "sku": "AST-PJ3", "batchNo": "—", "location": "BAY-05", "expected": 5, "actual": 4, "expired": 0, "waste": 0, "extra": 0, "classification": "MISSING", "reasonNarrative": "One unit unaccounted for.", "evidence": { "photos": [], "documents": [] } },
        { "productId": "A-03", "name": "Weighing Scale WS-7", "sku": "AST-WS7", "batchNo": "—", "location": "DOCK-01", "expected": 3, "actual": 3, "expired": 0, "waste": 0, "extra": 0 }
      ]
    },
    {
      "id": "AUD-2405-009", "name": "Weekly FG Audit - May W4", "warehouseId": "WH-04", "entity": "FG",
      "auditorUserId": "U-4", "status": "under_review", "createdAt": "2024-05-29T09:00:00+05:30",
      "updatedAt": "2024-05-29T16:10:00+05:30", "submittedAt": "2024-05-29T15:20:00+05:30", "auditDate": "2024-05-29",
      "products": [
        { "productId": "P-03", "name": "Curd 400g", "sku": "CRD-400", "batchNo": "B240521-08", "location": "CH-01", "expected": 200, "actual": 180, "expired": 0, "waste": 15, "extra": 0, "classification": "WASTE", "reasonNarrative": "Chiller-2 temperature breach overnight; 15 units spoiled.", "evidence": { "photos": [{ "caption": "Chiller temp log" }, { "caption": "Spoiled stock" }], "documents": [{ "name": "chiller2_templog.pdf", "size": "220 KB" }] } },
        { "productId": "P-01", "name": "Milk Pouch 500ml", "sku": "MILK-500", "batchNo": "B240522-02", "location": "CH-02", "expected": 500, "actual": 480, "expired": 0, "waste": 0, "extra": 0, "classification": "MISSING", "reasonNarrative": "20 pouches unaccounted; suspected pilferage at dock.", "evidence": { "photos": [], "documents": [] } },
        { "productId": "P-02", "name": "Paneer 200g", "sku": "PNR-200", "batchNo": "B240523-01", "location": "CH-03", "expected": 300, "actual": 300, "expired": 0, "waste": 0, "extra": 12, "classification": "EXTRA", "reasonNarrative": "12 extra blocks found — likely miscounted inbound receipt.", "evidence": { "photos": [], "documents": [] } }
      ]
    },
    {
      "id": "AUD-2405-006", "name": "FG Audit - May W2", "warehouseId": "WH-02", "entity": "FG",
      "auditorUserId": "U-1", "status": "submitted", "createdAt": "2024-05-27T09:00:00+05:30",
      "updatedAt": "2024-05-27T10:05:00+05:30", "submittedAt": "2024-05-27T10:05:00+05:30", "auditDate": "2024-05-27",
      "products": [
        { "productId": "P-05", "name": "Butter 100g", "sku": "BUT-100", "batchNo": "B240501-04", "location": "A-03-01", "expected": 250, "actual": 230, "expired": 20, "waste": 0, "extra": 0, "classification": "EXPIRED", "reasonNarrative": "20 units past shelf-life date on rack.", "evidence": { "photos": [{ "caption": "Expiry labels" }], "documents": [] } },
        { "productId": "P-04", "name": "Ghee 500ml", "sku": "GHEE-500", "batchNo": "B240505-02", "location": "A-03-02", "expected": 150, "actual": 140, "expired": 0, "waste": 0, "extra": 0, "classification": "MISSING", "reasonNarrative": "10 jars short; investigating handling.", "evidence": { "photos": [], "documents": [] } },
        { "productId": "P-07", "name": "Lassi 200ml", "sku": "LAS-200", "batchNo": "B240506-01", "location": "A-04-01", "expected": 400, "actual": 400, "expired": 0, "waste": 0, "extra": 0 }
      ]
    },
  ...
  "settlements": [
    { "id": "SET-2405-010", "auditId": "AUD-2405-010", "warehouseId": "WH-03", "entity": "Asset", "submittedAt": "2024-05-29T17:30:00+05:30", "priority": "high", "status": "pending_review" },
    { "id": "SET-2405-009", "auditId": "AUD-2405-009", "warehouseId": "WH-04", "entity": "FG", "submittedAt": "2024-05-29T15:20:00+05:30", "priority": "medium", "status": "under_review" },
    { "id": "SET-2405-006", "auditId": "AUD-2405-006", "warehouseId": "WH-02", "entity": "FG", "submittedAt": "2024-05-27T10:05:00+05:30", "priority": "medium", "status": "pending_review" }
  ],

  "actionTickets": [
    { "id": "AT-2405-015", "auditId": "AUD-2405-009", "productId": "P-03", "warehouseId": "WH-04", "entity": "FG", "title": "Recover chiller-breach loss — Curd", "description": "15 units of Curd 400g spoiled due to a Chiller-2 overnight temperature breach. Pursue recovery from the maintenance vendor under the AMC and confirm chiller repair.", "status": "open", "priority": "high", "assignedToUserId": "U-4", "createdByUserId": "U-APP", "createdAt": "2024-05-29T16:20:00+05:30", "comments": [ { "who": "Amit Singh", "when": "2024-05-29T16:22:00+05:30", "text": "Opened from settlement of AUD-2405-009. Attach the AMC reference before contacting the vendor." } ] },
    { "id": "AT-2405-014", "auditId": "AUD-2405-010", "productId": "A-01", "warehouseId": "WH-03", "entity": "Asset", "title": "Locate / recover missing forklift FL-12", "description": "Forklift FL-12 not found at bay 3. Trace movement logs and raise with security.", "status": "in_progress", "priority": "high", "assignedToUserId": "U-3", "createdByUserId": "U-APP", "createdAt": "2024-05-29T18:00:00+05:30", "comments": [ { "who": "Imran Khan", "when": "2024-05-30T09:10:00+05:30", "text": "Reviewing gate-pass logs for the last 3 weeks." } ] },
    { "id": "AT-2405-013", "auditId": "AUD-2405-006", "productId": "P-04", "warehouseId": "WH-02", "entity": "FG", "title": "Investigate short Ghee stock", "description": "10 jars of Ghee 500ml short at Pune Warehouse. Review handling and CCTV.", "status": "open", "priority": "medium", "assignedToUserId": "U-1", "createdByUserId": "U-APP", "createdAt": "2024-05-27T11:00:00+05:30", "comments": [] },
    { "id": "AT-2405-012", "auditId": "AUD-2405-003", "productId": null, "warehouseId": "WH-05", "entity": "FG", "title": "Cold-storage waste root cause", "description": "Repeated waste in cold storage — identify root cause across recent audits.", "status": "in_progress", "priority": "medium", "assignedToUserId": "U-5", "createdByUserId": "U-APP2", "createdAt": "2024-05-25T18:30:00+05:30", "comments": [] },
    { "id": "AT-2405-011", "auditId": "AUD-2405-001", "productId": null, "warehouseId": "WH-02", "entity": "Asset", "title": "Reconcile asset tag mismatch", "description": "Two assets with swapped tags; reconcile the register.", "status": "resolved", "priority": "low", "assignedToUserId": "U-3", "createdByUserId": "U-APP", "createdAt": "2024-05-23T16:30:00+05:30", "comments": [ { "who": "Imran Khan", "when": "2024-05-24T10:00:00+05:30", "text": "Tags corrected in the register; ready to close." } ] },
    { "id": "AT-2405-010", "auditId": "AUD-2405-007", "productId": null, "warehouseId": "WH-01", "entity": "Asset", "title": "Forklift asset location mismatch", "description": "Asset location register out of date after floor reshuffle.", "status": "closed", "priority": "low", "assignedToUserId": "U-6", "createdByUserId": "U-APP", "createdAt": "2024-05-27T17:20:00+05:30", "comments": [] }
  ],
